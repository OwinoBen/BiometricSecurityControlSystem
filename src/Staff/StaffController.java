...
import Criminal_Project.LoginController;
import Criminal_Project.option;
...
public class StaffController implements Initializable {
    ...
    @FXML
    private Pane crininalsListPane;

    @FXML
    private TableView<LoadData> tableView;

    @FXML
    private TableColumn<LoadData, String> tableAction;


    @FXML
    private TableColumn<LoadData, String> tableGender, tableStatus,tableCase,tableName,tableCriminal;
    ...
    @FXML
    private Pane addCriminalPane;

    @FXML
    private ImageView imageViewer;

    @FXML
    private TextField txtCriminalNo;

    @FXML
    private TextField txtCriminal;

    @FXML
    private TextField txtCaseNoDisplay;

    @FXML
    private TextField txtStatus;

    @FXML
    private TextField caseStatus;

    @FXML
    private Pane addcriminalMain;

    @FXML
    private Pane criminalDetailsPane;

    @FXML
    private TextField txtCriminalDetailLastName;
    @FXML
    private TextField txtCriminalDetailLastName1;


    @FXML
    private TextField txtCriminalDetailFirstName;
    @FXML
    private TextField txtCriminalDetailFirstName1;

    @FXML
    private TextField txtCriminalDetailMiddleName;
    @FXML
    private TextField txtCriminalDetailMiddleName1;

    @FXML
    private ComboBox<nationalityOption> comboboxCrinalDetailNationality;

    @FXML
    private TextField txtCriminalDetailGender,txtCriminalDetailStatu,txtCriminalDetailProvinc;
    ...
    @FXML
    private ComboBox<genderOption> comboboxCrinalDetailGender;

    @FXML
    private ComboBox<genderOption> comboboxCrinalDetailGender1;

    @FXML
    private TextField txtCriminalDetailCounty;

    @FXML
    private TextField txtCriminalDetailCounty1;


    @FXML
    private TextField txtCriminalDetailConstituency;

    @FXML
    private TextField txtCriminalDetailWard;

    @FXML
    private TextField txtCriminalDetailLocation;

    @FXML
    private TextField txtCriminalDetailSublocation;

    @FXML
    private TextField txtCriminalDetailVilage;
    ...
    @FXML
    private TextField txtCriminalDetailID;

    @FXML
    private TextField txtCriminalDetailEmail;

    @FXML
    private TextField txtCriminalDetailPhone;

    @FXML
    private TextField txtCriminalDetailPostallAddress;

    @FXML
    private TextField txtCriminalDetailZipCode;

    @FXML
    private TextField txtCriminalDetailCity;
    @FXML
    private TextField txtCriminalDetailConstituency1;

    @FXML
    private TextField txtCriminalDetailWard1;

    @FXML
    private TextField txtCriminalDetailLocation1;

    @FXML
    private TextField txtCriminalDetailSublocation1;

    @FXML
    private TextField txtCriminalDetailVilage1;

    @FXML
    private TextField txtCriminalDetailBornIn1;

    @FXML
    private ComboBox<provinceOption> comboBoxCriminalDetailCityProvince1;

    @FXML
    private TextField txtCriminalDetailID1;

    @FXML
    private TextField txtCriminalDetailEmail1;

    @FXML
    private TextField txtCriminalDetailPhone1;

    @FXML
    private TextField txtCriminalDetailPostallAddress1;

    @FXML
    private TextField txtCriminalDetailZipCode1;

    @FXML
    private TextField txtCriminalDetailCity1;

    @FXML
    private CheckBox RightThumbCheckBox;

    @FXML
    private CheckBox FirstfingerRightCheckBox;

    @FXML
    private CheckBox ThirdfingerRightCheckBox;

    @FXML
    private CheckBox SmallfingerRightCheckBox;

    @FXML
    private CheckBox SecondfingerRightCheckBox;

    @FXML
    private CheckBox LeftThumbCheckBox;

    @FXML
    private CheckBox FirstfingerLeftCheckBox;

    @FXML
    private CheckBox ThirdfingerLeftCheckBox;

    @FXML
    private CheckBox smallfingerLeftCheckBox;

    @FXML
    private CheckBox SecondfingerLeftCheckBox;

    @FXML
    private Button btnEnrollFingerPrint;

    @FXML
    private Button btncriminaldetailsNext;


    @FXML
    private Pane petionerPane;
...
*/
        ...
        tableView.setOnMouseClicked(e -> {
            ...
            String date = "SELECT * FROM residences WHERE criminal_No = ?";
            ...
            try {
                    ...
                    while (rs.next()){
                        ...
                        txtCriminalDetailCity1.setText(rs.getString("city"));
...
//                                alert.show();
    ...
    public void handleClicks(ActionEvent actionEvent){
        ...
        if(actionEvent.getSource() == btnAddCriminal){
            ...
            try {
                ...
                //addCriminalPane.setStyle("-fx-background-color: green");
            dashBordPane.setVisible(false);
    ...
    public void chooseFile(ActionEvent event) throws MalformedURLException, FileNotFoundException {
        ...
        if (event.getSource() == btncriminaldetailsNext) {
            ...
            String sqlResidence = "INSERT INTO residences(county,constituency,ward,location,sublocation,criminal_No) VALUES(?,?,?,?,?,?)";
            ...
            if (txtCriminalNo.getText().isEmpty() || txtCriminalDetailFirstName.getText().isEmpty() || txtCriminalDetailMiddleName.getText().isEmpty() || txtCriminalDetailLastName.getText().isEmpty() || comboboxCrinalDetailNationality.getSelectionModel().isEmpty()
                ...
                if (viewImage.getImage() == null) {
                    ...
                    if (!(phone.find() && phone.group().equals(txtCriminalDetailPhone.getText()))) {
                        ...
                        Alert alert = new Alert(Alert.AlertType.WARNING);
                        alert.setHeaderText("ID Number exceeds 8 digits ");
                        alert.setTitle("BCAEACS");
                        alert.showAndWait();
            ...
            if (txtVictimLastName.getText().isEmpty() || txtVictimFirstName.getText().isEmpty() || txtVictimMddleName.getText().isEmpty() || txtVictimPostcode.getText().isEmpty() || txtVictimZipcode.getText().isEmpty()
                ...
                if (!(pertionerFname.find() && pertionerFname.group().equals(txtVictimFirstName.getText()))
                    ...
                    try {
                        ...
                        PreparedStatement pst3 = conn.prepareStatement(sqlfir);//Age preparedStement object
                        ...
                        pst2.setString(9, txtVictimCounty.getText());
                        pst2.setString(10, txtPetionerConstituency.getText());
                        pst2.setString(11, txtPetionerLocation.getText());
...
//                            transport.close();
    ...
    public void generateCriminalNumber() throws NumberFormatException {
